            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-8">
                <div className="flex flex-col items-center gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center gap-3">
                        <div
                            aria-hidden
                            className="size-9 rounded-2xl bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 dark:from-violet-400/15 dark:to-fuchsia-400/15 border border-black/5 dark:border-white/10 backdrop-blur flex items-center justify-center"
                        >
                            <span className="text-xs font-semibold tracking-wide text-violet-700 dark:text-fuchsia-200">
                                LS
                            </span>
                        </div>
                ...
                <div className="mt-4 flex flex-col items-center gap-3 md:flex-row md:items-center md:justify-between">
                    ...
                    <p className="text-[11px] leading-tight text-slate-400 dark:text-slate-500">
                        © {new Date().getFullYear()} Leng Sopheaktra. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
